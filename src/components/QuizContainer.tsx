...
export function QuizContainer() {
  ...
  */
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-[url('/lovable-uploads/d75dd515-1fa2-4855-ad5e-8f29f3b0e2ef.png')] bg-cover bg-center bg-no-repeat bg-fixed">
